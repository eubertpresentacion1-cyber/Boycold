-- Migration: Create loyalty_transactions table for tracking loyalty point awards
-- This table will track loyalty bean/stamp awards with proper branch, device, and employee tracking
