...
<body>
    ...
    <section class="login-container">
        ...
        <div class="form-step active" id="step1">
            <h1>Welcome Back!</h1>
            <p>Manage orders and serve customers with ease.</p>
        ...
        loginForm.addEventListener("submit", function (e) {
            ...
            fetch("login.php", { method: "POST", body: formData })
                ...
                .then(data => {
                    ...
                    if (!data.success) {
                        if (data.errors.email) setError(email, emailError, data.errors.email);
                        if (data.errors.password) setError(password, passwordError, data.errors.password);
                        return;
                    }
