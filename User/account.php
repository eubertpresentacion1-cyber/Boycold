        ...
        <div class="account-grid">
                ...
                <div class="profile-info">
                    ...
                    <div class="edit-inline" id="address-edit">
                        <input type="text" id="address-input" placeholder="e.g. 123 Mango St, BGC" maxlength="200"
                            value="<?= $address ?>">
                        <button class="save-btn" onclick="saveField('address')">Save</button>
                        <button class="cancel-btn" onclick="toggleEdit('address')">Cancel</button>
                    </div>
                    ...
                    <div class="edit-inline" id="phone-edit">
                        ...
                        <button class="cancel-btn" onclick="toggleEdit('phone')">Cancel</button>
                    </div>
            ...
            <div class="card card-small">
                <div class="card-small-header">
                    ...
                    <div class="card-small-sub">No saved orders</div>
                </div>
                ...
                <div class="card-expanded-view">
                    ...
                    <div class="s-right">
                        ...
                        <div class="s-panel" id="s-panel-username">
                            <h2>Change User Name</h2><p>Update your display name.</p>
                        ...
                        <div class="s-panel" id="s-panel-email">
                            <h2>Change Email</h2><p>Update the email linked to your account.</p>
                        ...
                        <div class="s-panel" id="s-panel-address">
                            <h2>Saved Addresses</h2><p>Manage your saved delivery addresses.</p>
                        ...
                        <div class="s-panel" id="s-panel-phone">
                            <h2>Phone Number</h2><p>Update the mobile number linked to your account.</p>
                        ...
                        <div class="s-panel" id="s-panel-payment">
                            <h2>Payment Method</h2><p>Manage your saved payment methods.</p>
